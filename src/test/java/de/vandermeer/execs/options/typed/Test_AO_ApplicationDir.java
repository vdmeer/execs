...
public class Test_AO_ApplicationDir {

	AO_ApplicationDir_New getAo(Character cliShort){
		return new AO_ApplicationDir_New(cliShort, false, "my-arg", "short description");
	}

	@Test
	public void test_Constructor(){
		Test_TypedStatics.test_Constructor(getAo(null), "application-dir", false, "DIR");
	}

	@Test
	public void test_ConstructorShort(){
		Test_TypedStatics.test_ConstructorShort(getAo('d'), 'd', "application-dir", false, "DIR");
	}
