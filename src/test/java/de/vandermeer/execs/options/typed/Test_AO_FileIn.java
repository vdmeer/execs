...
public class Test_AO_FileIn {

	AO_FileIn_New getAo(Character cliShort){
		return new AO_FileIn_New(cliShort, false, "my-arg", "short description");
	}

	@Test
	public void test_Constructor(){
		Test_TypedStatics.test_Constructor(getAo(null), "input-file", false, "FILE");
	}

	@Test
	public void test_ConstructorShort(){
		Test_TypedStatics.test_ConstructorShort(getAo('d'), 'd', "input-file", false, "FILE");
	}
