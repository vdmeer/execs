...
public class Test_AO_TemplateDir {

	AO_TemplateDir_New getAo(Character cliShort){
		return new AO_TemplateDir_New(cliShort, false, "my-arg", "short description");
	}

	@Test
	public void test_Constructor(){
		Test_TypedStatics.test_Constructor(getAo(null), "template-dir", false, "DIR");
	}

	@Test
	public void test_ConstructorShort(){
		Test_TypedStatics.test_ConstructorShort(getAo('d'), 'd', "template-dir", false, "DIR");
	}
