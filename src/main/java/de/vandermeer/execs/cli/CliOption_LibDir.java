 ...
 */
public class CliOption_LibDir extends AbstractClioption {

	/**
	 * Returns the new CLI option.
	 * @param required true if option is required, false of it is optional
	 */
	public CliOption_LibDir(boolean required){
		Option.Builder builder = Option.builder();
		builder.longOpt("lib-dir");
		builder.hasArg().argName("DIR");
		builder.desc("specifies a directory with requried jar files");
