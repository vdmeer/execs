...
/**
 * Abstract implementation of an environment option of type integer.
 *
 * @author     Sven van der Meer &lt;vdmeer.sven@mykolab.com&gt;
 * @version    v0.4.0 build 170413 (13-Apr-17) for Java 1.8
 * @since      v0.5.0
 */
public class Option_TypedE_Integer extends Abstract_TypedE<Integer> {
	 ...
	 */
	public Option_TypedE_Integer(final String displayName, final String environmentKey, final boolean environmentIsRequired, final String description, final Object longDescription) {
