 ...
 * @since      v0.5.0
 */
public class AO_ID extends AbstractTypedC_String {
	 ...
	 */
	public AO_ID(Character cliShort, boolean isRequired, String argDescr, String description, Object longDescription) {
		super(
				"IDentifier",
