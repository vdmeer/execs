...
/**
 * Typed CLI option `property-file`.
 *
 * @author     Sven van der Meer &lt;vdmeer.sven@mykolab.com&gt;
 * @version    v0.4.0 build 170413 (13-Apr-17) for Java 1.8
 * @since      v0.5.0
 */
public class AO_PropertyFilename extends Option_TypedC_String {
	 ...
	 */
	public AO_PropertyFilename(final Character cliShort, final boolean isRequired, final String argDescr, final String description, final Object longDescription) {
		super(
				"Property File",
