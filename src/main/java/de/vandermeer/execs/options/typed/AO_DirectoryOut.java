 ...
 * @since      v0.5.0
 */
public class AO_DirectoryOut extends Option_TypedC_String {
	 ...
	 */
	public AO_DirectoryOut(final Character cliShort, final boolean isRequired, final String argDescr, final String description, final Object longDescription) {
		super(
				"Output Directory",
