 ...
 * @since      v0.5.0
 */
public class AO_DirectoryOut extends AbstractTypedC_String {
	 ...
	 */
	public AO_DirectoryOut(Character cliShort, boolean isRequired, String argDescr, String description, Object longDescription) {
		super(
				"Output Directory",
