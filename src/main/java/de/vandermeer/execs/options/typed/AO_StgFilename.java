 ...
 * @since      v0.5.0
 */
public class AO_StgFilename extends Option_TypedC_String {
	 ...
	 */
	public AO_StgFilename(final Character cliShort, final boolean isRequired, final String argDescr, final String description, final Object longDescription) {
		super(
				"STG Filename",
