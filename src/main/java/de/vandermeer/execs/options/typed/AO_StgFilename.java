 ...
 * @since      v0.5.0
 */
public class AO_StgFilename extends AbstractTypedC_String {
	 ...
	 */
	public AO_StgFilename(Character cliShort, boolean isRequired, String argDescr, String description, Object longDescription) {
		super(
				"STG Filename",
